var topN = {
	count : function(rankid,gpaid,fieldid,N){
		...
		currentAllocation = {'Chem':0,'Civil':0,'Comp':0,'Elect':0,'Mech':0,'Prod':0};
	...
	getData : function() {
		...
		var N = dropdown.selectedIndex+1;
		topN.count(rankid,gpaid,fieldid,N);
	...
	drawGraph : function(series){
		$(function () {
		    Highcharts.chart('graphContainer', {
		        ...
		        title: {
		            text: 'Allocation of Top Students'
		        },
		        subtitle: {
